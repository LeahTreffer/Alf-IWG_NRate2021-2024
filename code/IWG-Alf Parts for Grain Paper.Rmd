...
GraincomboplotNEZ <- ggplot(data=NdZSI) +
  ...
  geom_text(data = sortedZ_I, mapping = aes(x = 30, y = 1500, label = equation),  size=2)+ # add equation to figure
  geom_point(data = sym_I, aes(x = x_sym, y = y_sym), shape = 4, size = 1, inherit.aes = FALSE)+
  geom_text(data = sortedZ_M, mapping = aes(x = 30, y = 1400, label = equation),  size=2)+ # add equation to figure
  geom_point(data = sym_M, aes(x = x_sym, y = y_sym), shape = 25, size = 1, fill = "lightgrey", stroke = 0.6, inherit.aes = FALSE)+
  geom_text(data = sortedZ, mapping = aes(x = 60, y = 1500, label = plvl)) # add stars to figure
