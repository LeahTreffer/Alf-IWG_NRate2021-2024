...
# save grain_Nrate_yr2_emmeans_N:P
###
...
gt_NG |> gtsave("figures/gt_NG.png", expand = 10)
```
...
ggsave("figures/GraincomboplotNE.jpg", plot = GraincomboplotNE, width = 8, height = 6, dpi = 300)
```
...
print(GXPC)
ggsave("figures/GXPC.jpg", plot = GXPC, width = 8, height = 6, dpi = 300)
```
...
print(GYPC)
ggsave("figures/GYPC.jpg", plot = GYPC, width = 8, height = 6, dpi = 300)
```
...
GZPC<-ggplot(NdZSI, aes(x = P, y = exp(predicted), color = CROP)) +
  ...
  theme(plot.title = element_text(hjust = 0.5))+
    scale_y_continuous(breaks = c(250, 500, 750, 1000, 1250), limits = c(0, 1260))
print(GZPC)
ggsave("figures/GZPC.jpg", plot = GYPC, width = 8, height = 6, dpi = 300)
```

# combined grain year 1 and 2 plots E:C
```{r}
GEC<-grid.arrange(GXPC, GYPC, GZPC, ncol = 2)
ggsave("figures/GEC.jpg", plot = GEC, width =12, height = 6, dpi = 350)
```
...
print(GLERE)
# ggsave("figures/GPLER_yr1_E.jpg", plot = GLERE, width = 8, height = 6, dpi = 300)
```
...
print(GLERE)
# ggsave("figures/GPLER_yr2_E.jpg", plot = GLERE, width = 8, height = 6, dpi = 300)
```
...
print(GLERE)
# ggsave("figures/GPLER_yr3_E.jpg", plot = GLERE, width = 8, height = 6, dpi = 300)
```
...
# ggsave("figures/GPLERcomboplot.jpg", plot = GPLERcomboplot, width = 8, height = 6, dpi = 300)
```
...
# ggsave("figures/GRYXcomboplot.jpg", plot = GRYXcomboplot, width = 8, height = 6, dpi = 300)
...
GRYYcomboplot<-ggplot(NGRY_longY, aes(x = N, y = GRelativeYield)) +
  ...
  ggtitle("Year 2 Grain Relative Yield")+
    coord_cartesian(ylim = c(NA, NA))
# ggsave("figures/GRYYcomboplot.jpg", plot = GRYYcomboplot, width = 8, height = 6, dpi = 300)
...
GRYZcomboplot<-ggplot(NGRY_longZ, aes(x = N, y = GRelativeYield)) +
  ...
  ggtitle("Year 2 Grain Relative Yield")+
    coord_cartesian(ylim = c(NA, NA))
# ggsave("figures/GRYZcomboplot.jpg", plot = GRYZcomboplot, width = 8, height = 6, dpi = 300)
...
# ggsave("figures/GRYcomboplot.jpg", plot = GRYcomboplot , width = 8, height = 6, dpi = 300)
```
