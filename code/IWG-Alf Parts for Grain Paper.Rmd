...
GcomboplotNEXS <- ggplot(data=NdXSI) +
  ...
  labs(x = "N-Rate (Kg ha-1)", y = "Grain Yield")+
  scale_x_continuous(breaks = c(0, 40, 80, 120, 160)) +
  ylim(0, 2000) +
  facet_wrap(~P, scales = "free_y", ncol = 2,
  ...
  geom_function(data=subset(NdXSIG, P== "NY"), fun=~408.24*exp(0.0047*.x),color='darkgrey')+
  geom_function(data=subset(NdXSIG, P== "WI"), fun=~736.77*exp(-0.0001*.x),color='darkgrey')+
  geom_text(data = sortedX, mapping = aes(x = 20, y = 1800, label = equation),  size=3)+ # add equation to figure
  geom_text(data = sortedX, mapping = aes(x = 50, y = 1800, label = plvl))+ # add stars to figure
# add stars to figure
...
# ggsave("figures/Paper/GcomboplotNEXS.jpg", plot = GcomboplotNEXS, width = 10, height = 8, dpi = 300)
```
...
#  geom_point(data = subset(NdYSI, P== "MN"), aes(x = N, y = G, shape = CROP)) +
#  geom_point(data = subset(NdYSI, P== "NY"), aes(x = N, y = G, shape = CROP)) +
#  geom_point(data = subset(NdYSI, P== "WI"), aes(x = N, y = G, shape = CROP)) +
#  labs(x = "N-Rate (Kg ha-1)", y = "Grain Yield (Kg ha-1)", shape = "Cropping System", color = "Cropping System", linetype = "Cropping System")+
#  scale_x_continuous(breaks = c(0, 40, 80, 120, 160)) +
#  ylim(0, 1200) +
#  facet_wrap(~P, scales = "free_y", ncol = 2, labeller = as_labeller(c(KS='Kansas',
#                                      MN='Minnesota',
#                                      NY='New York',
#                                      WI='Wisconsin'))) +
#scale_shape_manual(values = c(4, 25),labels = c("Intercropped","Monoculture IWG"))+
  ...
  geom_text(data = sortedY_I, mapping = aes(x = 30, y = 1125, label = equation),  size=2)+ # add equation to figure
  geom_point(data = sym_I, aes(x = x_sym, y = y_sym), shape = 4, size = 1, inherit.aes = FALSE)+
  geom_text(data = sortedY_M, mapping = aes(x = 30, y = 1000, label = equation),  size=2)+ # add equation to figure
  geom_point(data = sym_M, aes(x = x_sym, y = y_sym), shape = 25, size = 1, fill = "lightgrey", stroke = 0.6, inherit.aes = FALSE)+
  geom_text(data = sym_I, mapping = aes(x = 60, y = 1125, label = plvl))+ # add stars to figure
  geom_text(data = sym_M, mapping = aes(x = 60, y = 1000, label = plvl))+ # add stars to figure
#scale_shape_manual(values = c(4, 25),
#                    labels = c("Intercropped", "Monoculture IWG"),
#                     breaks = c("inter","monoI"),
#                     name = "Cropping System") +
#  scale_linetype_manual(values = c(inter = "dotdash", monoI = "dashed"),
#                        labels = c(inter = "Intercropped", monoI = "Monoculture IWG"),
#                        breaks = c("inter","monoI"),
#                        name = "Cropping System") +
...
scale_shape_manual(name = "Cropping System",
                     labels = c(inter = "Intercropped", inter = "Intercropped", monoI = "Monoculture IWG", monoI = "Monoculture IWG"),
                     values = c(4, 25, 4, 25))+
  labs(x = "N-Rate (Kg ha-1)", y = "Grain Yield (Kg ha-1)", shape = "Cropping System") +
  scale_x_continuous(breaks = c(0, 40, 80, 120, 160)) +
  ylim(0, 1200) +
  facet_wrap(~P, scales = "free_y", ncol = 2,
             labeller = as_labeller(c(KS='Kansas', MN='Minnesota',
...
# ggsave("figures/Paper/GrainplotNECY.jpg", plot = GraincomboplotNECY, width = 10, height = 8, dpi = 300)
```
