...
#  ylim(0, 1600) +
  facet_wrap(~P, scales = "free_y",ncol=2)+ #make it by location (remove to make it across locations)
  scale_color_discrete(name = "Cropping System")  #legend for colors
# save figres/forage/IWGforage_Nrate_yr3F.jpeg  775x630
...
# START HERE : look at sig summary anova table and decide which figures to create

### Action items from Megan: 
# values and proportions of each species in total forage yeild for intercropped plots (not PrLER)
